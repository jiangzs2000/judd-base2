...
public class RMBUtils {
    ...
    public static String changeY2FRound(String amount){
        ...
        String bdnew = String.valueOf(bd.setScale(2, RoundingMode.HALF_UP));
        String amountNew = RMBUtils.changeY2F(bdnew);
        return amountNew;
    }

    public static void main(String[] args){

        String amount = "0.0156";
        String bb = RMBUtils.changeY2FRound(amount);
